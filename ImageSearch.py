...
def load_img_by_id(name, return_gray=True, folder_path='/Users/vedavyas/Desktop/CSE515/dataset/Hands_Test/'):
...
def compute_features_by_folder(folder_name, ftr_comp_func, return_gray=True,folder_base_path = '/Users/vedavyas/Desktop/CSE515/dataset/'):
    ...
    for fileName in fileNames:
        print fileName
        #print folder_path
        img = load_img_by_id(fileName,return_gray,folder_path)
...
def compute_features_by_file(file_name, ftr_comp_func, return_gray=True, file_base_path = '/Users/vedavyas/Desktop/CSE515/dataset/Hands_Test/'):
    feature_list = []
    fileNames = [file_name]
    print(file_name)
    img = load_img_by_id(file_name,return_gray,file_base_path)
    features = ftr_comp_func(img)
    feature_list.append(features)
    return pd.DataFrame({'FileName':fileNames,'Features':feature_list})
...
def save_features_for_view(filename, feature_df_input, save_folder = 'FileFeatures',save_base_path = '/Users/vedavyas/Desktop/CSE515/dataset/'):
...
def save_features_pickle(filename,feature_df, save_folder = 'FileFeatures',save_base_path = '/Users/vedavyas/Desktop/CSE515/dataset/'):
    path = save_base_path+'/'+save_folder+'/'+filename
...
if __name__== "__main__":
    ...
    if(input_model == "Color Moments"):
        if(model_run_mode=="Single Image (Task 1)"):
            ...
            loaded_features_df = pd.read_pickle('/Users/vedavyas/Desktop/CSE515/dataset/FolderFeatures/color_moments_features.pkl')
        ...
        if (model_run_mode == "Single Image (Task 1)"):
            ...
            loaded_features_df = pd.read_pickle('/Users/vedavyas/Desktop/CSE515/dataset/FolderFeatures/sift_features.pkl')
            print("Size of features loaded: ", loaded_features_df.shape)
